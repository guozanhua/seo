...
import org.jahia.services.seo.jcr.VanityUrlManagerInterface;
import org.jahia.services.seo.jcr.VanityUrlServiceInterface;
 ...
 */
public class VanityUrlServiceImpl implements VanityUrlServiceInterface {

    private static final Logger logger = LoggerFactory.getLogger(VanityUrlServiceImpl.class);

    private VanityUrlManagerInterface vanityUrlManager;
    ...
    /**
     * Injects the dependency to {@link VanityUrlManagerImpl}.
     *
     * @param vanityUrlManager
     *            the dependency to {@link VanityUrlManagerImpl}
     */
    public void setVanityUrlManager(VanityUrlManagerInterface vanityUrlManager) {
